...
/*
** These functions describe how the lexer should switch states depending on input
*/
typedef void		(*t_lex_transition)(char, t_lexer *);
typedef int			(*t_lex_action)(t_list **, char);
...
typedef struct			s_lexer
{
	...
	t_lex_transition	transitions[LEX_STATES];
}               t_lexer;
